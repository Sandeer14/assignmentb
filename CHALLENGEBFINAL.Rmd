...
```{r machine learning technique, include=FALSE}
...
prediction <- data.frame(Id = test$Id, machine_nnet = predict(lm_model_2, test_data, type="response"))
...
```{r estimatellmodel, include=FALSE}
...
```{r computetraining, include=FALSE}
